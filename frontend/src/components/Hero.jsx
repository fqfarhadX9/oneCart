...
function Hero({heroData, heroCount, setHeroCount}) {
  return (
    <div className='w-[40%] h-[100%] relative'>
        ...
        md:left-[10%] md:top-[90px] lg:top-[130px] left-[10%] top-[10px]'>
            <p>{heroData.text1}</p>
            <p>{heroData.text2}</p>
        </div>
        <div className='absolute md:top-[400px] lg:top-[500px] top-[160px] left-[10%] 
        gap-[10px] flex items-center justify-center'>
